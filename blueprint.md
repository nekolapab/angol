## *first enstrukcon*
yuz angold spelenq  az protokold en blueprint.md  egzempild en GEMINI.md  and padirnd en yuzir tirmenal  for awtpit tekst and faylz an foldirz neymz en /lib/. and updeyt refrensez globale for etc neym tceynj. so du not reneym tu standard englec eksept for Flutter standard konvencon neymz and freymwirk klasez sutc az lib\main.dart  lib\firebase_options.dart  ChangeNotifier  StatelessWidget ....
...
*  `lib/widgets/dayl_wedjet.dart`: lhe sentir modyil ov modyilz.
