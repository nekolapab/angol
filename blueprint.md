## *first enstrukcon*
yuz angolec spelenq  az protokold en blueprint.md  for faylz an foldirz neymz en /lib/ (eksept lib\main.dart and lib\firebase_options.dart) and olweyz updeyt refrensez. so du not reneym tu standard englec unles standard convencon klasez (freymewirk klasez layk ChangeNotifier, StatelessWidget, ...).

## *sekond enstrukcon*
olweyz yuz angolec spelenq en ol awtput.
